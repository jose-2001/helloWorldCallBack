...
{
    void response(String rs, boolean changeRunning, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_response(Callback obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        String iceP_rs;
        boolean iceP_changeRunning;
        iceP_rs = istr.readString();
        iceP_changeRunning = istr.readBool();
        inS.endReadParams();
        obj.response(iceP_rs, iceP_changeRunning, current);
