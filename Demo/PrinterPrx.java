...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default String fibonacci(int n)
    {
        return fibonacci(n, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String fibonacci(int n, java.util.Map<String, String> context)
    {
        return _iceI_fibonacciAsync(n, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> fibonacciAsync(int n)
    {
        return _iceI_fibonacciAsync(n, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> fibonacciAsync(int n, java.util.Map<String, String> context)
    {
        return _iceI_fibonacciAsync(n, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_fibonacciAsync(int iceP_n, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "fibonacci", null, sync, null);
        f.invoke(true, context, null, ostr -> {
