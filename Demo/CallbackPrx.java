...
{
    default void response(String rs, boolean changeRunning)
    {
        response(rs, changeRunning, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void response(String rs, boolean changeRunning, java.util.Map<String, String> context)
    {
        _iceI_responseAsync(rs, changeRunning, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> responseAsync(String rs, boolean changeRunning)
    {
        return _iceI_responseAsync(rs, changeRunning, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> responseAsync(String rs, boolean changeRunning, java.util.Map<String, String> context)
    {
        return _iceI_responseAsync(rs, changeRunning, context, false);
    }

    /**
     * @hidden
     * @param iceP_rs -
     * @param iceP_changeRunning -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_responseAsync(String iceP_rs, boolean iceP_changeRunning, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(false, context, null, ostr -> {
                     ...
                     ostr.writeBool(iceP_changeRunning);
                 }, null);
        return f;
    }
